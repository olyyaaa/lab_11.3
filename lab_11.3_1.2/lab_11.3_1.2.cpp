// lab_11.3_1.2.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
void Create(Student* p, const int N, char* fname)
{
...
void Sort(Student* p, const int N, char* fname)
{
